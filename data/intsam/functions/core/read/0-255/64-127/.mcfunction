...
execute if score intsam.__temp__:offset intsam.__temp__ matches 96..111 run function intsam:core/read/0-255/64-127/96-111/
execute if score intsam.__temp__:offset intsam.__temp__ matches 112..127 run function intsam:core/read/0-255/64-127/112-127/
