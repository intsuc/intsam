...
scoreboard objectives add intsam.__temp__ dummy
  ...
  execute if score intsam.__temp__:capacity intsam.__temp__ < intsam.__temp__:capacity intsam.__temp__ run data modify storage intsam.state: capacity set from storage intsam.__temp__:api/grow __input__.capacity
