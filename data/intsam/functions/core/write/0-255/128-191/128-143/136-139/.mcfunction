...
execute if score intsam.__temp__:offset intsam.__temp__ matches 138 store result storage intsam.front: memory[-1][138] int 1.0 run scoreboard players get intsam.__temp__:data intsam.__temp__
execute if score intsam.__temp__:offset intsam.__temp__ matches 139 store result storage intsam.front: memory[-1][139] int 1.0 run scoreboard players get intsam.__temp__:data intsam.__temp__
